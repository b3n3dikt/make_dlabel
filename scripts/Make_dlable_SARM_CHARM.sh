...
base_dir=/Users/bene.ramirez/projects/ROI_sets/RheMAP/CHARM-SARM_converted2YRK/
for i in $(seq 1 6); do
    level=${i}
    #level=1
    cAtlas=CHARM
    ...
    outpath=/Users/bene.ramirez/projects/ROI_sets/RheMAP/CHARM-SARM_converted2YRK/make_dlabel
